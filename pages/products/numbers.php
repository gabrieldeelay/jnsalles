    ...
    if ($status == '1') {
        ...
        foreach ($discounts as $discount) {
            ...
            if ($user_id) {
                ...
                echo '                  <span id="add_to_cart"></span>' . "\r\n" . '                  <button data-bs-toggle="modal" data-bs-target="#loginModal2" onclick="qtyRaffle(\'';
                echo $discount['qty'];
                echo '\', true);" class="btn btn-success w-100 btn-sm py-0 px-2 text-nowrap font-xss">' . "\r\n" . '               ';
            }
...
if ($user_id) {
    ...
    echo '               <span id="add_to_cart"></span>' . "\r\n" . '               <button data-bs-toggle="modal" data-bs-target="#loginModal2" class="btn btn-success w-100 py-3">' . "\r\n" . '               ';
}
