    ...
    <div class="container mx-auto draw-shell">
        ...
        <section class="draw-card">
            ...
            <div class="draw-stage">
                ...
                <div class="draw-result" id="draw-result"><p class="draw-winner-label" id="draw-winner-label">Ganhador</p><h3 id="draw-winner-name"></h3><p class="draw-result-phone" id="draw-winner-phone"></p><div class="draw-result-meta"><span>Cota: <strong id="draw-winning-number"></strong></span><span>Campanha: <strong id="draw-campaign-name"></strong></span><span><span id="draw-eligible-label">Participações:</span> <strong id="draw-eligible-count"></strong></span></div></div>
...
<button class="draw-settings-button" id="draw-settings-open" type="button" aria-label="Configurações da simulação" title="Configurações da simulação">⚙</button>
